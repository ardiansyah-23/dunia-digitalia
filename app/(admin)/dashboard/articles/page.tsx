...
const INITIAL_ARTICLES: ArticleItem[] = [
  { id: '1', title: 'Cara Optimasi SEO Template Blogger Agar Lolos Google AdSense', slug: 'cara-optimasi-seo-template-blogger', category: 'Blogger', status: 'Published', author: 'Admin Utama', date: '2 Agust 2026', coverImage: '' },
  { id: '2', title: 'Panduan Integrasi Payment Gateway Tripay di Next.js 15', slug: 'panduan-integrasi-tripay-nextjs-15', category: 'Next.js', status: 'Published', author: 'Admin Utama', date: '1 Agust 2026', coverImage: '' },
  { id: '3', title: 'Otomasi Toko Online Menggunakan Webhook & Firestore', slug: 'otomasi-toko-online-webhook-firestore', category: 'Tutorial', status: 'Draft', author: 'Admin Utama', date: '28 Jul 2026', coverImage: '' },
];
          ...
          <tbody className="divide-y divide-gray-100">
            {filtered.map((art) => (
              <tr key={art.id} className="hover:bg-gray-50">
                ...
                <td className="p-4 font-medium text-gray-800">{art.author}</td>
                <td className="p-4 text-gray-500">{art.date}</td>
                <td className="p-4">
                ...
                <td className="p-4 text-right space-x-2">
                  <button onClick={() => handleOpenEdit(art)} className="p-1.5 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700">
                    <Edit2 className="w-3.5 h-3.5" />
                  </button>
                  <button onClick={() => handleDelete(art.id)} className="p-1.5 rounded-lg bg-red-50 hover:bg-red-100 text-red-600">
          ...
          <div className="bg-white rounded-3xl max-w-3xl w-full p-8 space-y-6 max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-200">
            ...
            <form onSubmit={handleSave} className="space-y-4 text-xs">
              ...
              <div className="flex justify-end gap-2 pt-4 border-t border-gray-100">
                ...
                <button type="submit" className="btn-primary px-6">Simpan & Terbitkan</button>
              </div>
            </form>
          </div>
        </div>
